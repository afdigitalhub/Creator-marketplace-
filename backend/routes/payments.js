...
async function sendCourseAccessEmail({
  ...
  if (!email) {
    console.error("Course access email skipped: user email is missing.");
    return {
      ok: false,
      skipped: true,
  ...
  if (!RESEND_API_KEY) {
    console.error("Course access email skipped: RESEND_API_KEY is not configured.");
    return {
      ok: false,
      skipped: true,
  ...
  if (!RESEND_FROM_EMAIL) {
    console.error("Course access email skipped: RESEND_FROM_EMAIL is not configured.");
    return {
      ok: false,
      skipped: true,
  ...
  if (!courseId) {
    console.error("Course access email skipped: course ID is missing.");
    return {
      ok: false,
      skipped: true,
  ...
  const safeCourseTitle =
    courseTitle || "Your AF Digital Hub Course";
...
margin:0 0 24px;
">
Your access is active. Open your dashboard or start learning now.
</p>
...
margin-top:25px;
">
If you are not currently signed in, AF Digital Hub will take you through the normal sign-in process before opening your account.
</p>
...
Your access is active and you can start learning immediately from your AF Digital Hub account.
